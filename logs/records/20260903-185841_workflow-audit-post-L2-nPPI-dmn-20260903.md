# Run Record: workflow-audit-post-L2-nPPI-dmn-20260903

- Timestamp: 20260903-185841
- Branch: main
- Commit: 2b9d701
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/rf1-sra-ugr`
- Raw log: `/ZPOOL/data/projects/rf1-sra-ugr/logs/runs/20260903-185841_workflow-audit-post-L2-nPPI-dmn-20260903.log`
- Command exit: 0
- Check exit: none
...
```bash
python3 code/audit_workflow.py --sessions all --ppi-type nppi-dmn --fsl-root /ZPOOL/data/projects/rf1-sra-ugr/derivatives/fsl --output-dir logs/audits/20260903-post-L2-nppi-dmn
```

## Full Log

```text
RUN START: 20260903-185841
PROJECT_ROOT: /ZPOOL/data/projects/rf1-sra-ugr
GIT: main 2b9d701
HOST: CLA19787.tu.temple.edu
USER: tug87422
PWD: /ZPOOL/data/projects/rf1-sra-ugr
COMMAND: python3 code/audit_workflow.py --sessions all --ppi-type nppi-dmn --fsl-root /ZPOOL/data/projects/rf1-sra-ugr/derivatives/fsl --output-dir logs/audits/20260903-post-L2-nppi-dmn
...
L2 nppi-dmn complete/eligible: 332/341
L2 nppi-dmn todo: 9
L2 nppi-dmn blocked by L1: 1
Detailed reports: /ZPOOL/data/projects/rf1-sra-ugr/logs/audits/20260903-post-L2-nppi-dmn
