# Run Record: workflow-audit-post-activation-20260831

- Timestamp: 20260831-181353
- Branch: main
- Commit: 1e4f021
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/rf1-sra-ugr`
- Raw log: `/ZPOOL/data/projects/rf1-sra-ugr/logs/runs/20260831-181353_workflow-audit-post-activation-20260831.log`
- Command exit: 0
- Check exit: none
...
```bash
python3 code/audit_workflow.py --sessions all --seed dACC --output-dir logs/audits/20260831-post-activation
```

## Full Log

```text
RUN START: 20260831-181353
PROJECT_ROOT: /ZPOOL/data/projects/rf1-sra-ugr
GIT: main 1e4f021
HOST: CLA19787.tu.temple.edu
USER: tug87422
PWD: /ZPOOL/data/projects/rf1-sra-ugr
COMMAND: python3 code/audit_workflow.py --sessions all --seed dACC --output-dir logs/audits/20260831-post-activation
...
L2 activation complete/eligible: 313/339
L2 activation todo: 26
...
Detailed reports: /ZPOOL/data/projects/rf1-sra-ugr/logs/audits/20260831-post-activation
