# Run Record: workflow-audit-pre-nPPI-ECN-20260902

- Timestamp: 20260902-212501
- Branch: main
- Commit: 4b6d44e
- Host: CLA19787.tu.temple.edu
- User: tug87422
- Working directory: `/ZPOOL/data/projects/rf1-sra-ugr`
- Raw log: `/ZPOOL/data/projects/rf1-sra-ugr/logs/runs/20260902-212501_workflow-audit-pre-nPPI-ECN-20260902.log`
- Command exit: 0
- Check exit: none
...
```bash
python3 code/audit_workflow.py --sessions all --ppi-type nppi-ecn --output-dir logs/audits/20260902-pre-nppi-ecn
```

## Full Log

```text
RUN START: 20260902-212501
PROJECT_ROOT: /ZPOOL/data/projects/rf1-sra-ugr
GIT: main 4b6d44e
HOST: CLA19787.tu.temple.edu
USER: tug87422
PWD: /ZPOOL/data/projects/rf1-sra-ugr
COMMAND: python3 code/audit_workflow.py --sessions all --ppi-type nppi-ecn --output-dir logs/audits/20260902-pre-nppi-ecn
...
Detailed reports: /ZPOOL/data/projects/rf1-sra-ugr/logs/audits/20260902-pre-nppi-ecn
